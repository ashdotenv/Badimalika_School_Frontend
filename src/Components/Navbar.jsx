        ...
        <nav className="bg-white shadow-md z-10">
            <div class="flex justify-around items-center py-4">
                <div class="flex-shrink-0">
                    <a href="#" class="text-2xl font-extrabold text-blue-600">Badimalika School</a>
                </div>
                        ...
                        <div className="relative group">
                            <button className="flex items-center space-x-1 hover:text-blue-600 font-medium">
                                ...
                                >
                                    <path
                                        fillRule="evenodd"
                                        d="M5.293 7.707a1 1 0 011.414 0L10 11.414l3.293-3.707a1 1 0 011.414 0z"
                                        clipRule="evenodd"
                                    />
                                </svg>
                            </button>
            ...
            <div id="mobile-menu" className="hidden md:hidden bg-white shadow-lg">
                ...
                <Link className="block px-4 py-2 hover:bg-gray-100" to="/about-us/about">
                    About Us
                </Link>
                <div className="relative">
                    <button
                        id="mobile-academics-btn"
                    ...
                    <div id="mobile-academics" className="hidden bg-gray-100">
                        <Link className="block px-4 py-2 hover:bg-gray-200" to="/academics/curriculum">
                            Curriculum
                        </Link>
                        <Link className="block px-4 py-2 hover:bg-gray-200" to="/academics/faculty">
                            Faculty
                        </Link>
                        <Link className="block px-4 py-2 hover:bg-gray-200" to="/academics/admission">
                            Admission
                        </Link>
                    </div>
                </div>
                <div className="relative">
                    ...
                    <div id="mobile-activities" className="hidden bg-gray-100">
                        <Link className="block px-4 py-2 hover:bg-gray-200" to="/activities/sports">
                            Sports
                        </Link>
                        <Link className="block px-4 py-2 hover:bg-gray-200" to="/activities/clubs">
                            Clubs
                        </Link>
                        <Link className="block px-4 py-2 hover:bg-gray-200" to="/activities/events">
                            Events
                        </Link>
                    </div>
                </div>
                <Link className="block px-4 py-2 hover:bg-gray-100" to="/contact/contact">
                    Contact
                </Link>
            </div>
        </nav>
